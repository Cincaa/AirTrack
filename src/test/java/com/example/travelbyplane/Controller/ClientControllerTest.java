...
class ClientControllerTest {
    ...
    public static void setup(){
        request = new Client("Adrian", "Cinca", "123456789",null);
    }
    ...
    void addClient() throws Exception {
        Client client = new Client("Adrian", "Cinca", "123456789",false);
        client.setId(300);
    ...
    void findFlightNoClient() throws Exception {
        ...
        mockMvc.perform(get("/travelByPlane/client/{clientId}/searchFlight/{departureCity}/{arrivalCity}/{date}", anyLong(), "Bucharest", "Iasi", "16-02-2024"))
                .andExpect(status().isNotFound());
    }

    @Test
    void findFlightNoTExist() throws Exception {
        Client client = new Client("Adrian", "Cinca","123456789", true);
        client.setId(12);
